class Config:
    def __init__(self):
        self.generate_model_name = "llama3-70b-8192"
        self.function_calling_model_name = "llama3-70b-8192"
        self.extraction_model_name = "llama3-70b-8192"
        self.preprocess_model_name = "llama3-70b-8192"
        ...
        self.bot_name = "DUTChat, Chatbot hỗ trợ tư vấn thông tin của Đại học Bách Khoa Đà Nẵng"
        self.bot_type = "uac"
