QUERY_CONTEXTUAL_SYSTEM_PROMPT = """Bạn là chuyên gia trong việc đặt lại câu hỏi dựa theo ngữ cảnh của cuộc hội thoại về  Trường đại học Bách Khoa Đà Nẵng.
...
Câu hỏi được đặt lại như sau: "Tôi muốn biết thông tin tuyển sinh về ngành Công nghệ thông tin tại Trường đại học Bách Khoa Đà Nẵng?"
...
QUERY_REWRITING_SYSTEM_PROMPT = """Bạn là chuyên gia trong việc phân tích và xử lý câu hỏi tư vấn của người dùng thành các ý nhỏ hoàn chỉnh.
...
Câu hỏi được đặt lại như sau: "Tôi muốn biết thông tin tuyển sinh về ngành Công nghệ thông tin tại Trường đại học Bách Khoa Đà Nẵng?", "Tôi muốn biết thông tin về thời gian xét tuyển về ngành Kế toán tại Trường đại học Bách Khoa Đà Nẵng?"
